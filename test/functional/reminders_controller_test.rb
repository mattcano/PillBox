...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { date: @reminder.date, medication_id: @reminder.medication_id, message: @reminder.message, user_id: @reminder.user_id }
    end
  ...
  test "should update reminder" do
    put :update, id: @reminder, reminder: { date: @reminder.date, medication_id: @reminder.medication_id, message: @reminder.message, user_id: @reminder.user_id }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
